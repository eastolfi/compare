    ...
    public static List<Delta> compare(Object source, Object target, final ID idFetcher)
    {
        ...
        while (!stack.isEmpty())
        {
           ...
           System.out.println("path = " + path);
            ...
            if (DeepEquals.deepEquals(idFetcher.getId(source), srcValue) && DeepEquals.deepEquals(idFetcher.getId(target), targetValue)) {
                // Is and ID
                continue;
            }
            ...
            {
                compareObjects(delta, deltas, stack, idFetcher);
            }
            else
